function fiber_photometry_video_sync_v3
    % Create a UI figure
    fig = uifigure('Name', 'Fiber Photometry and Video Synchronization', 'Position', [100, 100, 1200, 800]);
    ...
    timeLabel = uilabel(fig, 'Position', [500, 30, 150, 20], 'Text', 'Time: 0.00 s', ...
        'FontSize', 12, 'HorizontalAlignment', 'center');
    
    % Axes for displaying the video
    axVideo = uiaxes(fig, 'Position', [20, 300, 960, 400]);
    axis(axVideo, 'off');  % Hide axes for better video display
    
    % Axes for plotting 470/410 signal
    axSignal = uiaxes(fig, 'Position', [20, 100, 960, 180]);
