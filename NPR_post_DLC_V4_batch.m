...
for i = 1:length(csv_files)
    ...
    [exploreROI1, exploreEventsROI1, totalTimeROI1, timestampsROI1] = detectExploration(inROI1, center1, radius1, bodyX, bodyY, noseX, noseY, fps, window_size, min_overlap, movement_threshold, stable_frames_threshold);
    [exploreROI2, exploreEventsROI2, totalTimeROI2, timestampsROI2] = detectExploration(inROI2, center2, radius2, bodyX, bodyY, noseX, noseY, fps, window_size, min_overlap, movement_threshold, stable_frames_threshold);
...
function [exploreFlags, numEvents, totalTime, timestamps] = detectExploration(inROI, center, radius, bodyX, bodyY, noseX, noseY, fps, window_size, min_overlap, movement_threshold, stable_frames_threshold)
    ...
    %   stable_frames_threshold - Number of frames to check for stability
