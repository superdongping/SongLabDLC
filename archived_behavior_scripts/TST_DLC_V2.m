...
% retrieves FPS from the first MP4 file, performs analysis from 0 to 360 seconds, and saves the results accordingly.
...
for i = 1:length(csvFiles)
    ...
    analysisEndTime = 360;     % End at 360 seconds (updated from 300 seconds)
    ...
    % Total immobile time from 0 to 360 seconds
    totalImmobilizedTime_analysis = sum(analysisImmobilized) / fps;
    
    % Latency to first immobility within 0-360 seconds
    ...
    fprintf('Total Immobilized Time (0-360s): %.2f seconds\n', totalImmobilizedTime_analysis);
